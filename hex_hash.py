...
import requests	
 ...
 url = 
'https://api.github.com/repos/alfredclwong/3GM1/contents/Arduino/hashes.txt'	
...
#subprocess.check_call(f"\"{avr_exe}\" -c arduino -p m328p -C 
\"{avr_conf}\" -P \"{port}\" -b 57600 -U flash:r:{hex_fname}:i")	
...
if req.status_code == requests.codes.ok:	
    ...
    verified_hashes = 
base64.b64decode(req['content']).decode().split('\n')	
